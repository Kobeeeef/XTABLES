...
//    }
//
//    private <T> RequestAction<ResponseStatus> subscribeUpdateEventNoCheck(String key, Class<T> type, Consumer<XTableProto.XTableMessage> consumer) {
...
//    }
//
//    public RequestAction<ResponseStatus> subscribeUpdateEvent(Consumer<KeyValuePair<byte[]>> consumer) {
//        String key = " ";
...
//    }
//
//    private <T> void processUpdate(KeyValuePair<byte[]> keyValuePair, String key) {
...
//                    }
//                } else {
//                    UpdateConsumer<byte[]> typedUpdateConsumer2 = (UpdateConsumer<byte[]>) updateConsumer;
//                    Consumer<? super KeyValuePair<byte[]>> consumer2 = typedUpdateConsumer2.getConsumer();
//                    try {
